...
module.exports = {
	config: {
		...
		longDescription: {
			en: "This command allows you to upload files to adc and sends the link to the file."
		},
		category: "Utility",
		guide: {
			en: "To use this command, type !adc <filename>. The file must be located in the 'cmds' folder."
		}
	},
